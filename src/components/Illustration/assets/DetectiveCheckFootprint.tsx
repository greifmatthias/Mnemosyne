...
import Svg, {Ellipse, Path, Polygon, SvgProps} from 'react-native-svg';

export const DetectiveCheckFootprint: FC<SvgProps> = props => {
  ...
  return (
    <Svg viewBox="0 0 865.76 682.89" {...props}>
      ...
      />
      <Path
        d="M287.26,626.61s-1.29-3.78-3.81-5.54c0,0,8.68-1.47,12.61,1.41S290.75,626.29,287.26,626.61Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M343,606.23s-1,3.72-3.34,5.38c0,0,8.89,1.76,12.6-1S346.57,606.67,343,606.23Z"
        fill={colors.primary.base}
      />
      <Path
        d="M172.26,618.65v-5a9.33,9.33,0,0,1,3.89,1.48C178.72,617,175.67,618.06,172.26,618.65Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M219.53,605s-.65,3.78-2.9,5.63c0,0,9,1,12.49-2S223.11,605.16,219.53,605Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M403.39,629.3s-1.57-3.68-4.21-5.24c0,0,8.54-2.12,12.68.46S406.85,628.72,403.39,629.3Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M455.46,608.88s-1.18,3.66-3.66,5.17c0,0,8.78,2.28,12.64-.22S459,609.53,455.46,608.88Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M516.08,626.61s-1.29-3.78-3.81-5.54c0,0,8.68-1.47,12.62,1.41S519.57,626.29,516.08,626.61Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M568.27,612.36s-.66,3.78-2.9,5.63c0,0,9,1,12.48-2S571.84,612.51,568.27,612.36Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      />
      <Path
        d="M628.82,630.29s-1.29-3.79-3.82-5.54c0,0,8.68-1.47,12.62,1.41S632.3,630,628.82,630.29Z"
        fill={colors.primary.base}
      />
      <Path
      ...
      <Path
        ...
        fill={colors.secondary.shade40}
      />

      <Path
        d="M359.66,360.48s-61.53-5.64-81.72-55.1l7-11.36s47.65,2.92,77.93,61.51Z"
        fill={colors.secondary.shade20}
      />

      <Path
        d="M305.17,302.66c-2.09-1-4.27-1.91-6.59-2.76l-4.45,7.27c2.27.83,4.6,1.72,7,2.67Z"
        fill={colors.secondary.shade40}
      />
      <Path
        d="M307.19,303.67l-4.14,7a139.8,139.8,0,0,1,16.24,7.9l2.15-4.9A69.27,69.27,0,0,0,307.19,303.67Z"
        fill={colors.secondary.shade40}
      />
      <Path
        d="M323.41,321.08a71.56,71.56,0,0,1,6.5,4.69l1.62-2c-2.14-2.36-4.19-4.5-6.21-6.49Z"
        fill={colors.secondary.shade40}
      />

      <Path
        d="M284,306.75s37,12.48,67.53,47.73C351.54,354.48,302.52,344.82,284,306.75Z"
      ...
      <Path
        d="M379.43,381.7c-.36,12.49,19.66.84,18-7.22-1.36-6.48-7.17.41-9.19,1.95S380.47,379.1,379.43,381.7Z"
        fill="#f9b499"
      />
      ...
      <Path
        ...
        fill={colors.neutral.neutral100}
      />
      ...
      <Ellipse
        ...
        rx="39.26"
        ry="51.98"
        transform="translate(-36.97 217.65) rotate(-30)"
        fill="#f9b499"
      />
      ...
      <Path
        d="M417.49,140.3s18.24-.82,26.9,2.07c0,0-6.25-12-34.65-11.55S417.49,140.3,417.49,140.3Z"
        fill={colors.secondary.shade40}
      />
      ...
      <Path
        d="M394.91,145.54a.08.08,0,0,0,0,0S394.92,145.54,394.91,145.54Z"
        fill={colors.secondary.shade40}
      />
      ...
      <Path
        d="M467.86,222a106.27,106.27,0,0,0,21.63-13.63c-5.44-4.62-8.33-11.49-11-18.1l-15.54-38c-7.86.32-15.77,1-23.59,1.74,9.9,18.94,1.34,43.08,9.46,62.85,5.5,13.37,18.06,22.81,31.57,28,8.58,3.27,17.6,5,26.73,6.31C492.52,243.61,479,234.49,467.86,222Z"
        opacity="0.2"
        fill={colors.neutral.neutral00}
      />
      ...
      <Path
        d="M619.23,293.43a115.69,115.69,0,0,0-33.45-36.95A57.26,57.26,0,0,1,619.23,293.43Z"
        opacity="0.2"
        fill={colors.neutral.neutral00}
      />

      <Polygon
        points="284.01 306.75 174.41 604.85 413.85 604.85 351.54 354.48 284.01 306.75"
        fill={colors.primary.tint40}
        opacity="0.5"
      />

      <Path
        d="M385.87,370.44a33.93,33.93,0,0,1-11.93,6.15"
        fill="none"
        stroke="#f9b499"
        strokeMiterlimit="10"
      />
      ...
      <Path
        d="M393.56,372.16a50,50,0,0,1-13.83,11.75"
        fill="none"
        stroke="#f9b499"
        strokeMiterlimit="10"
      />
      ...
      <Path
        d="M387.77,386.35s7.09-4.09,9.63-11.87"
        fill="none"
        stroke="#f9b499"
        strokeMiterlimit="10"
      />
